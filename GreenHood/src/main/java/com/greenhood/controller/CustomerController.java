...
//public ResponseEntity<Cart> addPlantToCart(@PathVariable("pid") Integer pid, @PathVariable("key") String key) throws CustomerException, AuthorizationException,PlantException {
//    
